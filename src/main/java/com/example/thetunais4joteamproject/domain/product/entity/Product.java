...
public class Product extends BaseEntity {
	...
	private Product(Long memberId, Category category, String name, int price, String description, String imageUrl,
	...
	// 정적 팩토리 메서드
	public static Product of(Long memberId, Category category, String name, int price, String description,
		ProductStatus status) {
